            ...
            <div class='row px-2'>
                <div class='p-0 bg-trans'>
                    <nav class='navbar navbar-expand-lg justify-content-between'>
                        <a class="navbar-brand" href="#"><img id="MDB-logo" src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1702984668/NairaDirect-Images/logo1_2_agzs2t.png" alt="Logo" draggable="false" height="30" /></a>
