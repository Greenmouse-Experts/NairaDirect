                ...
                <div class="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                    <div class="bottom-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="/">Naira Wallet</a></li>
                            <li><a href="/">Buy/Sell E-Currencies</a></li>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <ul>
                                    ...
                                    <li><a href="/">Referrals & Affiliates</a></li>
                                </ul>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="copyright">
                        <p>© Copyright 2023 <a href="/">Naira Direct</a> I All Rights Reserved</p>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
