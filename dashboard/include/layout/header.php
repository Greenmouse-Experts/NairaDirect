                                ...
                                <div class="dropdown-wrapper">
                                    <div class="card mb-0">
                                        <div class="card-header p-3 text-center">
                                            ...
                                            <div class="mt-2">
                                                <h6 class="mb-0 lh-18">Hamzat Adeleke</h6>
                                            </div>
                                        </div>
            ...
            <div class="logo">
                <a href="#" class="d-flex align-items-center gap-3 flex-shrink-0">
                    ...
                    <div class="position-relative flex-shrink-0">
                        <!-- <img src="https://res.cloudinary.com/greenmouse-tech/image/upload/v1702931811/eyvre8n6kz9a18vadbzl-removebg-preview_gegkpj.png" alt="" class="logo-text">
                        ...
                        <li class="nav-item nav-notification dropdown">
                            ...
                            <div class="dropdown-widget dropdown-menu p-0">
                                <div class="dropdown-wrapper pd-50">
                                    ...
                                    <h6 class="all-notifications"> <a href="#" class="btn bg-muted text-primary w-100 fw-bold mt-3 ff-heading px-0">View
        ...
        <div class="kleon-navmenu">
            <ul class="main-menu">
                ...
                <li class="menu-item">
                    <a href="#">
                        <span class="nav-icon flex-shrink-0">
                            <i class="bi bi-box-arrow-left fs-20"></i>
                        </span>
                        <span class="nav-text">
                            Log Out
                        </span>
